      ...
      <div className='main-container'>
        ...
        <div className='wrapper-main-projects'>
          <div className='container-box-projects'>
            ...
            <div className='about-me animated fadeIn'>This Portfolio is built from ground up and I'm planning on adding more projects to it. I never stop creating and always work on new projects to learn new tricks and technologies. Check out my recent projects below and <a href='https://s3.us-east-2.amazonaws.com/resume-natalia/NATALIA+CALT.pdf' target='_blank' rel='noopener noreferrer'>resume here.</a></div>
